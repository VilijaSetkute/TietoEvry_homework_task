...
const Search = () => {
    ...
    const {dishType, setDishType, mealType, setMealType, setRecipes, setShowSearch,
        searchMessage, setSearchMessage, searchKeyword, setSearchKeyword, searchError, setSearchError} = useContext(mainContext)
    ...
    return (
        <div className='container search'>
            ...
            <input ref={recipeName} type="text" placeholder='enter ingredient' className='my-1 w-100 input-unmerged' onChange={handleKeyword}/>
            <div className='my-2'>
            ...
            <div className='d-flex justify-content-end'>
                <button className='btn btn-outline-secondary my-1 me-2' onClick={clearSearch}>Clear search</button>
                <button className='btn btn-outline-success my-1' onClick={handleSearch}>Search</button>
            </div>
