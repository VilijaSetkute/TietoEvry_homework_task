  ...
  return (
    <div>
      <div className="text-center">
        <div className="d-flex justify-content-center fw-bold fs-4 mb-2 mt-5 bg-success bg-opacity-25 rounded py-2">
              ...
              <div className="d-flex justify-content-center">
                <table className="table w-75 .table-responsive">
                  ...
                  <tbody>
                    ...
                    <tr className={(calsStatistics.proteins.proteinsLeft === 0 || calsStatistics.total.totalLeft === 0)
                        ? 'text-danger' : 'undefined'}>
                      <td>Proteins</td>
