  ...
  return (
    <div>
      <div className="counter d-flex flex-column">
        ...
        <fieldset className="mb-2" onChange={genderValue}>
          ...
          <div>
            ...
            <label htmlFor="counter-male">Male</label>
          </div>
          <div>
            <input type="radio" id="counter-female" name="gender" value="female" className="me-1" />
            <label htmlFor="counter-female">Female</label>
          </div>
        </fieldset>
      ...
      <div className="overflow-box">
        {weightLogs.map((x, i) => <CalorieLogList key={x} log={x} />).reverse()}
      </div>
    </div>
